export const ProjectData = [
    {
        id: 1,
        title:"Fitmeals",
        about: "Fitmeals.co.in is an online food delivering website, which deals with wholesome & nourishing foodsthat make people feel the best version of themself.",
